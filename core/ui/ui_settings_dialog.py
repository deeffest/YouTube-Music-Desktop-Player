...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        spacerItem = QtWidgets.QSpacerItem(293, 54, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(275, 196, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"• Ctrl + Shift + Right: Next."))
        ...
        self.checkBox_12.setToolTip(_translate("SettingsDialog", "This setting removes the 60 FPS limit, but may consume more CPU resources."))
        self.checkBox_12.setText(_translate("SettingsDialog", "Disable frame rate limit"))
